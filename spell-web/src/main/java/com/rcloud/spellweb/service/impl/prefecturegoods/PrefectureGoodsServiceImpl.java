package com.rcloud.spellweb.service.impl.prefecturegoods;
...
public class PrefectureGoodsServiceImpl implements PrefectureGoodsService {
    ...
    @Override
    public int delete(Integer pgId) {
        return mapper.deleteByPrimaryKey(pgId);
    }
    ...
    @Override
    public PageInfo<GoodsEntity> getGoodsList(PrefectureGoodsEntity entity) {

        PageHelper.startPage(entity.getPageNum(), entity.getPageSize());

        List<GoodsEntity> list = mapper.getGoodsList(entity);
    ...
    public PageInfo<PrefectureGoodsEntity> getPrefectureGoodsListPage(PrefectureGoodsEntity entity) {
        ...
        List<PrefectureGoodsEntity> list = mapper.selectByExample(entity);
